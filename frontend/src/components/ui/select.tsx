...
// ==========================================
// Select - Estilo Minimalista Vercel
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "rounded-lg border border-white/10 bg-transparent px-3 py-2 text-sm",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-lg border border-white/10 bg-black shadow-xl",
